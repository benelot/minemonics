...
\todo[inline]{Recapture the sinusoid evolved creatures and produce an animation from it.}
\begin{figure}[tb]
\centering
...
\todo[inline]{Draw indirect limit controller joint complex.}
\begin{figure}[H]
%\hspace*{-4.2in}
...
\todo[inline]{Draw direct limit controller joint complex diagram.}
\begin{figure}[H]
%\hspace*{-1.2in}
...
\todo[inline]{Recapture the chaotic controller evolved creatures and draw an animation from it}
\todo[inline]{Add links to the creatures gait videos on youtube}
\todo[inline]{Produce a finger cinema from videos}
\begin{figure}[H]
\centering
...
\todo[inline]{Rewrite these sentences}

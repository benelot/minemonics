...
\caption[Figure of a walker using chaotic controllers.]{Figure of a walker using the chaotic controllers. It has two large feet it stands on, which push the body forward. The in the front there is a stabilizing block that in certain cases touches the ground if the creature tips during its gait.}

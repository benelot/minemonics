...
%
To get a qualitative measure of stability, all controllers of the three creatures were perturbed in the beginning of their evaluation using small uniformly distributed zero mean perturbances of amplitude \([0,1 \cot 10^-8]\) to see if the locomotion stays stable. %
%

...
I would like to thank Professor Ruedi Stoop for his patience, numerous advices and kind critique. I am very grateful for all the support, discussions and material I was provided by the Stoop group, especially I want to thank Thomas Lorimer and Karlis Kanders for their help with the implementation of the chaotic model and limiter control, the interpretation of the data and the helpful discussions leading to different improvements of this thesis. In addition I want to thank my girlfriend Perrine Dubuis for her support during my studies and work on my thesis, without which I would not have had the same patience for the countless failed experiments and evolutionary runs without usable results. She invented the name for the simulator, which, in her opinion, means 'a thing that can do everything'. I hope my simulator can cope with these high expectations. Furthermore, I want to thank Randolph Busch and Karlis Kanders for proof-reading this thesis and for finding inconsistencies in reasoning and explanations.

...
%
It seems that a chaotic system's dimension limiting itself increased the range of different of periodic limit cycles again when compared to the case where of dimension limiting another. %
%
...
%
When the model leg is damped, a subset within the original limit cycle of the undamped joint can be observed. %
%

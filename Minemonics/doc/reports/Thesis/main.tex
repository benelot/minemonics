...
%
The adaptive system though is not only the central pattern generator, but the whole complex of pattern generator, the limbs and the connecting joints, that self-adapts to the external constraints. %
%
%
%
...
%
The evolution simulator was run to evolve locomoting creatures on land using a sinusoidal controller to evolve reference creatures to be compared to the ones using chaotic controllers.%
%
...
%
The increased joint torque leads to a larger limit cycle, however does not make the system switch to a higher periodicity in either the controller or joint phase space as it was expected. %
%
The evolution simulator could successfully evolved creatures using the sinusoidal and the chaotic controllers. %
%

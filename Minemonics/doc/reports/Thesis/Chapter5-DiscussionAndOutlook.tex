...
%
In experiments with the hand-made model leg, featuring one single joint connecting two body parts, different periodic orbits could be stabilized. %
%
...
%
Unfortunately, only some creatures feature simple limiter control behavior, while others do not. %
%
So it is not the case that locomotion can only arise if the joint dynamics perform stable periodic trajectories. %
%
Still, given that it works in some creatures shows that it is a valid hypothesis to be pursued further.

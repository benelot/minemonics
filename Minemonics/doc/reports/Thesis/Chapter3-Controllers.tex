...
\todo[inline]{Draw the sinusoid controller diagram.}
\begin{figure}[H]
%\hspace*{-1.2in}
\input{Pictures/controllers/sinusoid-controller.tikz}

\caption[The sinusoid controller]{The specification of the sinusoid controller, its internal state and output signal. The internal state has the same dimensionality as the output.}
...
\todo[inline]{Draw the chua controller diagram}
\begin{figure}[H]
%\hspace*{-1.2in}
\input{Pictures/controllers/chua-controller.tikz}

\caption[The chaotic chua controller]{A figure of the chaotic chua controller, its internal state and output signal. The internal state of the chaotic chua controller is three dimensional because the Chua circuit is defined using three dimensions. The output signal is chosen to be the z dimension of the internal state and is therefore only one dimensional.}

...
\caption[Directly encoded genome]{A figure of the same example creature using a directly encoded genome. The mirror flag and the repetitions do not exist, therefore the genotype is basically a direct representation of the phenotype.}
\label{figure:direct-encoding}
\end{figure}
...
%
Now we create the new body part according to the morphogene specifications. %
%

...
\todo[inline]{Generally very complicated sentences}
...
%
The influence factors in the morphogene branch are the flip and the mirror flag, responsible for two types of symmetry, that are described in the context of the embryogenesis in section \label{subsec:embryogenesis}.
...
\todo[inline]{Remove window frames from the picture to increase the actually important part of the picture}
...
%
Then the processing of a morphogene and its morphogene branches is repeated until a halting condition is reached and works as follows:%
\todo[inline]{Produce a pseudocode segment or a diagram showing the embryogenesis}

%
The first generator is taken out of the list, then and it is checked if the total limb limit or the limb depth limit defined by the individual is reached. %
%
...
\todo[inline]{This table can be represented much easier}
...
\todo[inline]{Put this segment to the beginning to be not redundant.}

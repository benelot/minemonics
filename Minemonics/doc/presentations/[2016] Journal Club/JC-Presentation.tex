...
\frame{
  ...
  \begin{itemize}
  \item G. Ren, W. Chen. et al., "Multiple chaotic central pattern generators with learning for legged locomotion and malfunction compensation", Information Sciences 294 (2015)
  \item S.Steingrube, M. Timme et al., "Self-organized adaptation of a simple neural
circuit enables complex robot behaviour", Nature Physics 6 (2010)
  \item A. Cully, J. Clune et al. "Robots that can adapt like animals", Nature 521 (2015)
  \end{itemize}
}
\note{}

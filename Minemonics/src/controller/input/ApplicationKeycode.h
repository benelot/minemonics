...
enum Keycode
{
    ...
    APPK_KP_EQUALSAS400 =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_EQUALSAS400),
    ...
    APPK_THOUSANDSSEPARATOR =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_THOUSANDSSEPARATOR),
    APPK_DECIMALSEPARATOR =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_DECIMALSEPARATOR),
    APPK_CURRENCYUNIT = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_CURRENCYUNIT),
    APPK_CURRENCYSUBUNIT =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_CURRENCYSUBUNIT),
    APPK_KP_LEFTPAREN = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_LEFTPAREN),
    APPK_KP_RIGHTPAREN = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_RIGHTPAREN),
    APPK_KP_LEFTBRACE = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_LEFTBRACE),
    APPK_KP_RIGHTBRACE = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_RIGHTBRACE),
    ...
    APPK_KP_DBLAMPERSAND =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_DBLAMPERSAND),
    APPK_KP_VERTICALBAR =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_VERTICALBAR),
    APPK_KP_DBLVERTICALBAR =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_DBLVERTICALBAR),
    ...
    APPK_KP_MEMSUBTRACT =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_MEMSUBTRACT),
    APPK_KP_MEMMULTIPLY =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_MEMMULTIPLY),
    ...
    APPK_KP_CLEARENTRY = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_CLEARENTRY),
    ...
    APPK_KP_HEXADECIMAL =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KP_HEXADECIMAL),
    ...
    APPK_BRIGHTNESSDOWN =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_BRIGHTNESSDOWN),
    APPK_BRIGHTNESSUP = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_BRIGHTNESSUP),
    APPK_DISPLAYSWITCH = APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_DISPLAYSWITCH),
    APPK_KBDILLUMTOGGLE =
        APP_SCANCODE_TO_KEYCODE(APP_SCANCODE_KBDILLUMTOGGLE),

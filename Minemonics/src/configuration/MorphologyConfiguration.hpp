...
public:
	...
	static const double LIMB_INITIAL_FRICTION = 1.0f; /**!< The limb initial friction */
	...
	static const double JOINT_MIN_DAMPING_COEFFICIENT = 0.5f;//0.05f;//0.005f; /**!< The minimum damping coefficient of the joint */

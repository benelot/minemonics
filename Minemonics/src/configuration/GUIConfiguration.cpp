...
//		physicsMenu->addChild(gravityTopItem);
	...
	const std::string GUIConfiguration::marsMercuryGravityName = "Mars/Mercury Gravity 0.377 g";
	const std::string GUIConfiguration::marsMercuryGravityCmd = "cmdMarsMercuryGravity";
	...
	const std::string GUIConfiguration::venusSaturnGravityName = "Venus/Saturn Gravity 0.91 g";
	const std::string GUIConfiguration::venusSaturnGravityCmd = "cmdVenusSaturnGravity";
	...
	const std::string GUIConfiguration::neptuneGravityName = "Neptune Gravity 1.12 g";
	const std::string GUIConfiguration::neptuneGravityCmd = "cmdNeptuneGravity";

	// Jupiter gravity 2.36
	const std::string GUIConfiguration::jupiterGravityName = "Jupiter Gravity 2.36 g";

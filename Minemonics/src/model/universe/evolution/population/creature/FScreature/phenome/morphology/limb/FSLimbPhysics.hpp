...
public:
	 ...
	 */
	bool equals(const FSLimbPhysics & limbPhysics) const;
	...
	friend std::ostream & operator<<(std::ostream &os,
		const FSLimbPhysics &limbPhysics) {
...
BOOST_CLASS_VERSION(FSLimbPhysics, 1)
BOOST_SERIALIZATION_ASSUME_ABSTRACT(FSLimbPhysics)

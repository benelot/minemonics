...
public:
	...
	FSJointPhysics();
	virtual ~FSJointPhysics();

	virtual FSJointPhysics* clone() = 0;
...
//	virtual bool isStrained() = 0;
	 ...
	 */
	bool equals(const FSJointPhysics & jointPhysics) const;
	...
	friend std::ostream & operator<<(std::ostream &os,
		const FSJointPhysics &jointPhysics) {
...
BOOST_CLASS_VERSION(FSJointPhysics, 1)
BOOST_SERIALIZATION_ASSUME_ABSTRACT(FSJointPhysics)

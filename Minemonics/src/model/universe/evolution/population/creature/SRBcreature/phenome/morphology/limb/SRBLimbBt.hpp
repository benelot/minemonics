#ifndef MODEL_UNIVERSE_EVOLUTION_POPULATION_CREATURE_PHENOME_MORPHOLOGY_LIMB_SRBLimbBt_HPP_
#define MODEL_UNIVERSE_EVOLUTION_POPULATION_CREATURE_PHENOME_MORPHOLOGY_LIMB_SRBLimbBt_HPP_
...
public:
	...
	friend std::ostream & operator<<(std::ostream &os,
		const SRBLimbBt &SRBLimbBt) {
		return os << "SRBLimbBt: LimbPhysics=" << SRBLimbBt; /**!< The limb physics model of the limb bullet model*/
	}
	/**

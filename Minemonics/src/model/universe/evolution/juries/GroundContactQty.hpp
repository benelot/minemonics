#ifndef MODEL_UNIVERSE_EVOLUTION_JURIES_GROUNDCONTACTQTY_HPP_
#define MODEL_UNIVERSE_EVOLUTION_JURIES_GROUNDCONTACTQTY_HPP_
 ...
 */
class GroundContactQty: public Jury {
public:
	GroundContactQty();
	GroundContactQty(const bool higherIsBetter, const double weight);
	virtual ~GroundContactQty();
	...
	virtual GroundContactQty* clone();
	...
	friend std::ostream & operator<<(std::ostream &os,
		const GroundContactQty &avgHeightJury) {
		return os;
	}

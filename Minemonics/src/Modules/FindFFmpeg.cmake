# - Find libavcodec, libavformat and libswscale
# Find the libavcodec, libavformat and libswscale include directories
# and libraries
#
# This module defines
...
#   LIBSWSCALE_LIBARY       - libswscale library
...
if( PKG_CONFIG_FOUND )
    ...
    #Same as above, but searching for libswscale instead
...
if( FFMPEG_FOUND )
    ...
    message( STATUS "\tlibavformat: ${LIBSWSCALE_INCLUDE_DIR}, ${LIBSWSCALE_LIBRARY}" )
    message( STATUS "\tlibavformat: ${LIBAVUTIL_INCLUDE_DIR}, ${LIBAVUTIL_LIBRARY}" )
endif( FFMPEG_FOUND )

mark_as_advanced( LIBAVCODEC_LIBRARY LIBAVFORMAT_LIBRARY LIBSWSCALE_LIBRARY LIBAVUTIL_LIBRARY)

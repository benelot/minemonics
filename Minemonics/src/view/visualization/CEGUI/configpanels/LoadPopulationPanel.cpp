...
LoadPopulationPanel::LoadPopulationPanel(const int left, const int top,
...

	{
		...
		mEvaluationTypeCb->subscribeEvent(
			...
			CEGUI::Event::Subscriber(&LoadPopulationPanel::onValueChanged,
				this));
...

	{
		...
		mConfirmButton->subscribeEvent(CEGUI::PushButton::EventClicked,
			CEGUI::Event::Subscriber(&LoadPopulationPanel::onConfirmClicked,
				this));
...
void LoadPopulationPanel::onValueChanged() {
...
void LoadPopulationPanel::onConfirmClicked() {

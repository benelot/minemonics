...
LoadPlanetPanel::LoadPlanetPanel(const int left, const int top,
...

	{
		...
		mEvaluationTypeCb->subscribeEvent(
			...
			CEGUI::Event::Subscriber(&LoadPlanetPanel::onValueChanged, this));
...

	{
		...
		mConfirmButton->subscribeEvent(CEGUI::PushButton::EventClicked,
			CEGUI::Event::Subscriber(&LoadPlanetPanel::onConfirmClicked, this));
...
void LoadPlanetPanel::onValueChanged() {
...
void LoadPlanetPanel::onConfirmClicked() {

#ifndef VIEW_VISUALIZATION_CEGUI_ELEMENTS_CONFIGPANELS_EDITPLANETPANEL_HPP_
#define VIEW_VISUALIZATION_CEGUI_ELEMENTS_CONFIGPANELS_EDITPLANETPANEL_HPP_
...
#endif /* VIEW_VISUALIZATION_CEGUI_ELEMENTS_CONFIGPANELS_EDITPLANETPANEL_HPP_ */
